...
**Mike**: You both wanna do it? Uhm... <strong style="color: red">there’s only room for one</strong>.

> `there's only room for one` 只有 1 个位置，也可以说 `There's only one spot.` 只剩一个位置/名额了。

**Chandler**: Pick me, I look great in a tux and I will not <strong style="color: red">steal focus</strong>.
...
>`not feel comfortable doing sth`: 做某事心里不太舒服
> comfortable 只是指心理不适，或者“物理”上的难受，比如新鞋挤脚、椅子太硬等；如果是身体不适可以用`I'm not feeling well` 之类的
...
**Ross**: Please, you’re <strong style="color: red">going down</strong>!

> `go down`：一种挑衅、或自信宣战的意思，表示“你输定了！”。被打败、失败、或者垮台。生动地用拳击比赛中被“打倒”的画面来表示这哥意思。
...
**Joey**: So, you know I’m <strong style="color: red">filling in for</strong> Phoebe’s step dad, tomorrow, right?

> `fill in for`：暂时替代（某人）或顶替（某人）的工作、角色或职责
...
> `what are your intensions with sb/sth`: 你对……到底是怎么打算的。这里必须用复数，`intentions`。

**Mike**: I intend to marry her.

> - **"Made her" -> "Mader":** 因为那是日常琐事，态度是**放松**的，所以发音是**偷懒**的。
> - **"Marry her" -> "Marry Her":** 因为这是人生大事，态度是**郑重**的，所以发音是**清晰**的

**Joey**: Oh, a <strong style="color: red">wiseacre</strong>. (Mike looks bewildered). No, no, no, I understand <strong style="color: orange">you</strong> plan <strong style="color: orange">to</strong> support your wife by playing the piano? Isn’t that kind of unstable?

> `wiseacre` 指的是自以为无所不知、喜欢卖弄小聪明、但（通常）并不真正有智慧的人，他们的“聪明”往往让人觉得讨厌或好笑。
> 在现代美语中，`smart aleck`、`wise guy`甚至更粗俗一点的`wiseass`已经完全取代了`wiseacre`的生态位。

>**"Isn't that" 的真实发音是：**
> **"Iz-un-nat"** 或 **"Iz-un-dat"** (/ˈɪzənæt/ 或 /ˈɪzəndæt/)

- `th` (/ð/) 通常会被同化成一个**弱弱的 /n/ 或 /d/**，但**绝对不会变成 /z/**。

> 反问句句末是否需要升调：
> 真的在问 (Genuine Question)，升调；寻求共鸣、反讽、表达观点，降调。
...
> 这里`what`会听到 "schwa"，这是因为 Ross 用力释放 /t/ 音时喷出的“气流尾巴”**。这代表他在**犹豫、在**思考**，或者单纯就是在**犯尴尬**。
...
> - **Chandler 的读法 (/mzm/):** 适合**强调**、**第一次提及**、或者**戏剧化表达**（“出大事了！”）。
> - **日常的读法 (/m:ən/):** 适合**日常流利口语**、**复述**、或者**觉得累的时候**
放心大胆地用 **"Groom---mn"** 吧！只要您把那个鼻音哼得够长，老外绝对听得懂那是复数。这比磕磕绊绊地去发那个 /z/ 要好听一万倍。

> fall out: 掉队/离开队列；另外在其他语境还有可能有其他的意思：1）发生争执、闹翻了；2) 晕倒、虚脱 It was so hot in the church that one of his groomsmen fell out.

**Phoebe**: Oh no, no. I can’t choose between you two! I love you both so much!

> 当“弱小”的 `/θ/` (th) 遇到“强势”的 `/s/` 时，`/θ/` 几乎总是会输掉这场“打架”，被 `/s/` 吃掉。

**Chandler**: Just not enough to put us in the original wedding party.

> `not enough`: `~t en~` linking；**实际听感：** **"No-duh-nuff"** ( /nɑː**d**ɪˈnʌf/ )
> `to`: `/tə/`
> `put us in`: linking **"Pu-duh-sin"** ( /pʊdəsɪn/ )
...
> - **不要念：** All - Right (欧 - 莱特) ❌   
> - **试着念：** **Aw-right** (奥 - r-wait) ✅
> - **感觉：** 叹一口气，肩膀一耸，嘴巴懒懒地张开一下就合上。

> `Guess I'll`  老师标注的是 /sail/，但是我听起来是 /səl/，感觉 Phoebe 在这里弱读了
...
>`Do I have a` /Dwy-vuh-MIN-it-ta-go-da-BATH-room?/ `have`的`h`被击穿
...
**Phoebe**: Ok. Hello everyone and thank you all for being here tonight. 

So tomorrow’s the big event and some of you might not know, but Mike and I didn’t get off to the best start. (she reads a note). 

> **拼写重构：** `Some of you` $\rightarrow$ **Sum-a-you** (或者 **Sum-muh-you**)。
> `might not know` **实际版：** **My-na-no**。

My friend Joey and I decided to fix each other up with friends so I, I... 
> `fix each other up`: "Fik-see-chuh-the-rup"

(Monica is twirling her hands in order to make Phoebe speed up her speech) oh I... hum... I gave it a lot of thought and I fixed him up with my friend Mary Ellen who couldn’t be here tonight because... (Monica is tapping her watch with her finger) it’s not important... she is in rehab. 

Anyway, so, ok, Joey said that he was <strong style="color: orange">fixing me up</strong> with his friend Mike, only he didn’t have a friend Mike so he just brought, uhm, my Mike and, and (Monica clears her throat) but despite, you know... it got... it got good. 

> `fix me up` Y-Glide **Me up** $\rightarrow$ 中间是 **Y** (Me-**y**-up)

Ok, I wanna take a moment to mention my mother, who couldn’t be here...

**Monica** (rolling her eyes): oh God.

**Phoebe**: And... moment’s over! (Rachel, Joey and Chandler all turn and look disapprovingly towards Monica but she just shrugs it off) So, ok, uh, I can forget that. I can forget that and uhm... (she’s flipping cards skipping half of them) Oh this is funny! Oh, but you need to know that to... that, to... Oh, ok, well, uhm, I (Monica is miming CUT). Ok, ok, I, ok, I.... MONICA I CAN’T DO IT LIKE THIS! THIS IS MY WEDDING! OKAY, I DON’T WANT THIS (she mimes Monica’s when she was twirling her hands) OR THIS (she taps her watch) OR THIS (she mimes CUT) OK? I JUST <strong style="color: orange">WANTED A </strong>SIMPLE WEDDING! WHERE MY FIANCEE CAN GO TO THE BATHROOM ANYTIME HE WANTS! (pause) You know what? You’re done.
...
**Rachel**: Ok-dokey, Joey, listen. This is gonna be <strong style="color: red">bridesmaid central</strong>, all right? We’re gonna have hair and make-up going on in the bathroom and oh, I had to move a couple of things in the fridge to make room for the corsages.

> `bridesmaid central`: 伴娘指挥中心/大本营 `Noun + Central` 关于某事的活动中心/集散地

**Joey**: Oh, man! I wouldn’t <strong style="color: yellow">have had</strong> breakfast if I knew <strong style="color: yellow">there</strong> was going to be corsages!

> `have had` 中的 `had`被 Joey“吃”了，`I wouldn-ad breakfast`
> `there`：前面是 `/n/` 开头的发音，`there`是 `/TH/` 开头的发音，Joey直接从 knew 过渡到 was，将 there 含糊处理了。`wuz-gun-na-be`
...
> `I Prin-ni-dəm-mout-on-my-Com-pyu-der.`
...
**Ross**: I have to <strong style="color: yellow">>talk to her about</strong> this groomsman situation, ok? I’m not gonna watch Chandler up there while I’m sitting in the seats like some chump! (he goes to Rachel’s room, knocks the door and enters the room). (very fake gasp) Oh! My God! You’re breathtaking!

> **"Tok-tu-wer-ra-bout"** ( /tɔːk tu wər rəˈbaʊt/ )
...
> `marrying you` 中不要按照中文习惯拖长 `ing`，其实很短，甚至可以被“吞”掉
...
> **实际听感：** **"May-I-va-word"** ( /meɪ aɪ və wɜːrd/ )
...
> **Kain-da-va"** ( /kaɪndə və/ ) **Lo-da-do"** ( /lɑɾə du/ )
...
> take care of her: **"Care-ra-ver"** ( /ˈker.ə.vər/ )
...
> `mos~~t~~ important thing in my life`: mos(t) impor... 连读
> `I'd die`: I 顿下 stop release，然后发die
> `let anything` Flap T + 连读
...
>`H omitted in had`
>`little` 可以发 `/lidl/`，甚至 Joey 在这里偷懒为 `/lil/`
...
> `be such an ass`: 觉得某人**不仅蠢，还自大、粗鲁、或者不可理喻**时，这句话是完美的形容。
...
> `...news it's...` 这里 its 会发成`/ts/`
> `They already`: `They` reduced to `The` + `already` **实际听感：** **"Th-ol-dy"** ( /ð'ɔːldi/ ) `already`：这里 dark l 和 r 打架时，L会战胜R，
> 这里 `twenty` 没有和一般的 `NT 规则`一样只发`/n/`，是因为这里是强调“二十年一遇”，所以没有做任何弱化。

**Monica**: Ooh! But the band and the photographer are coming all the way in from New Jersey!

> `...band and...` `Band` + `ən` = **Ban-dən**
> `the photagrapher` **实际听感：** **/ðə vuh-tɑːɡrəfər/** 在极速模式下，声带表示：“我不想为了中间那个微不足道的 /f/ 专门停下来再重启！太累了！” 于是，声带决定**一直保持震动**。
...
> `to the`: `~t~` + `~ð~` 辅音挤压 **实际听感：** **"Tuh-thuh"** ( /tə ðə/ )
> `most of`: `~t~` deleted + `~s~` links to `~əv~` **实际听感：** **"Mos-sov"** ( /moʊs əv/ )


**Rachel**: Since when do you watch the news?

> `when`： `/wən/` `Since when` 在英语口语中有惊讶、讥讽的暗示。不要轻易使用。

**Joey**: Uh, for your information, since they hired a very hot weather girl.

> `for your information`：同样也有“反驳”的味道
> `just so you know`：语气平和的版本
> `for your record`：正式

**Ross**: (To Phoebe and Mike) I can’t believe you guys aren’t `going to be` able to get married today.

> `gonna to be`：`to` completely deleted + `be` reduced **实际听感：** **"Gonna-buh"** ( /gʌnə bə/ )，不过 Ross 这里 be 没有做弱化
> `able to`: `t` becomes Flap T **实际听感：** **"Able-da"** ( /eɪbəl də/ )

**Phoebe**: I know.

**Rachel**: Wow, you know, it’s so beautiful out there. Yo`u a`lways wanted to get married outside. Why don’t you guys just do it on the street?

`You always`： Gliding vowel `you [w]always`

**Phoebe**: What?

**Rachel**: Well, look, it’s hardly snowing anymore. I mean you couldn’t `ask for a` more romantic setting. This could be the simple wedding you’`ve al`ways wanted!

`ask for a`： 这里 `for` 不会被弱读，因为和 ask 是一个语义单元；`for a `会连读。
...
> `had to`: `~d t~` merge $\rightarrow$ Unreleased Stop **实际听感：** **"Hæd-(停顿)-tə"** ( /hæd̚ tə/ )
...
> **实际听感：** **"So-y'Re-di-d-this"** ( /soʊ j ˈrɛdi d dɪs/ )
...
> `broken arrow`: 军事术语，表示涉及核武器的意外事故，但不会引发核战争
...
> `blssed event`:
> - _The Blessed Virgin_ (圣母) $\rightarrow$ `Bles-sid`
> - Every blessed day_ (每一天/该死的每一天) $\rightarrow$ `Bles-sid`
>
>作为表语、或动词过去式时，读 `/blɛst/`

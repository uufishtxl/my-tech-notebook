...
> `...news it's...` **News** 结尾是 **/z/** ，**It's** 结尾是 **/s/** (中间的 /ɪ/ 弱读消失，/t/ 变成 Stop)。   **/z/** (浊) 和 **/s/** (清) 是一对孪生音。当它们相遇时，前面的强音 (/z/) 会掩盖后面的弱音 (/s/)。
> `They already`: `They` reduced to `The` + `already` **实际听感：** **"Th-ol-dy"** ( /ð'ɔːldi/ )
